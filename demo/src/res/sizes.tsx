...
const sizes = new (class {
  ...
  _width =
    Dimensions.get('screen').width < Dimensions.get('screen').height
      ? Dimensions.get('screen').width / 375 //dọc
      : Dimensions.get('screen').width / 812; //ngang
  // ngang
  _height =
    Dimensions.get('screen').width > Dimensions.get('screen').height
      ? Dimensions.get('screen').height / 812 //ngang
      : Dimensions.get('screen').height / 375; //dọc
